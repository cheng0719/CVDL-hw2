...
class GraffitiBoard(QWidget):
    ...
    def initUI(self):
        ...
        self.canvas_label.setAlignment(Qt.AlignTop)
        self.canvas_label.setFixedSize(351, 271)

        # Create a pixmap to be used as the canvas with a black background
        self.pixmap = QPixmap(self.canvas_label.size())
        self.pixmap.fill(Qt.black)

        # Create a QImage to store the drawn shapes
        self.image = QImage(self.pixmap.size(), QImage.Format_RGB32)
        ...
        # Track the last point for drawing lines
        self.last_point = QPoint()

    def clearBoard(self):
        # Clear the main pixmap and update the canvas
        self.pixmap.fill(Qt.black)

        # Clear the QImage for drawn shapes
        self.image.fill(Qt.black)
        self.update()
    ...
    def mouseMoveEvent(self, event):
        if event.buttons() == Qt.LeftButton:
            ...
            # Draw the QImage onto the main pixmap
            painter_pixmap = QPainter(self.pixmap)
            painter_pixmap.drawImage(0, 0, self.image)
            painter_pixmap.end()
    ...
    def get_image_data(self):
        # Get the image data from the QImage
